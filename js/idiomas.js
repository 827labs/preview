var IDIOMAS = {
    es: {
        ...
        strings: {
            ...
            'nuestras-redes': { html: 'Nuestras redes' },
            'contacto': { html: 'Contacto' },
            'slider-1': { attr: { src: 'img/slider/1.png' } },
            'slider-2': { attr: { src: 'img/slider/2.png' } },
    ...
    en: {
        ...
        strings: {
            ...
            'nuestras-redes': { html: 'Our social networks' },
            'contacto': { html: 'Contact' },
            'slider-1': { attr: { src: 'img/slider/en/1.png' } },
            'slider-2': { attr: { src: 'img/slider/en/2.png' } },
    ...
    fr: {
        nombre: 'François',
        strings: {
            'sobre-nosotros': { html: 'Qui sommes nous' },
            'nuestras-redes': { html: 'Nos réseaux sociaux' },
            'contacto': { html: 'Contact' },
            'slider-1': { attr: { src: 'img/slider/fr/1.png' } },
            'slider-2': { attr: { src: 'img/slider/fr/2.png' } },
    ...
    pt: {
        nombre: 'Portuguese',
        strings: {
            'sobre-nosotros': { html: 'Sobre Nós' },
            'nuestras-redes': { html: 'Nossas redes sociais' },
            'contacto': { html: 'Contato' },
            'slider-1': { attr: { src: 'img/slider/pt/1.png' } },
            'slider-2': { attr: { src: 'img/slider/pt/2.png' } },
